    ...
    protected class OFChannelHandler 
        ...
        public void exceptionCaught(ChannelHandlerContext ctx, ExceptionEvent e)
            ...
            if (e.getCause() instanceof ReadTimeoutException) {
                // switch timeout
                ((ReadTimeoutException) e.getCause()).printStackTrace();
        ...
        protected void processOFMessage(OFMessage m)
            ...
            switch (m.getType()) {
                case HELLO:
                    ...
                    log.debug("receive a hello message");
                ...
                case GET_CONFIG_REPLY:
                    ...
                    if (cr.getMissSendLength() == (short)0xffff) {
                        ...
                        log.debug("Config Reply from {} has " +
                                 "miss length set to {}", 
        ...
        switch (m.getType()) {
            case PACKET_IN:
                ...
                if (pi.getPacketData().length <= 0) {
                    log.debug("Ignoring PacketIn (Xid = " + pi.getXid() +
            ...
            default:
                ...
                if (messageListeners.containsKey(m.getType())) {
                    ...
                    log.debug("didn't find listener for " + m.getType().toString() + " message");
                }
